# LABORATORIO 3 : Posizionamento dei poli mediante regolatore
...
```
## Passo 1 : Verificare le proprietà di ossevabilità e raggiungibilità del sistema linearizzato
...
eigAminLC = eig(A-L*C)
```
## Passo 3 : Progettare il vettore riga K
```Matlab
%%PARTE 3:
...
## Passo 4 : Definizione del sistema controllato
```Matlab
%% PARTE 4 :
...
```
## Passo 5 : Simulazione del sistema
```Matlab
%% PARTE 5 :
